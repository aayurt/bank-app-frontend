...
class _$_LoginApiRequestModel implements _LoginApiRequestModel {
  const _$_LoginApiRequestModel({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'LoginApiRequestModel(email: $email, password: $password)';
  }
...
abstract class _LoginApiRequestModel implements LoginApiRequestModel {
  const factory _LoginApiRequestModel(
      ...
      required final String password}) = _$_LoginApiRequestModel;
